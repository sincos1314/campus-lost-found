...
> 一个面向高校学生与教师的失物招领系统，支持失物/拾物发布、收藏与认领、物品评论、实时私信、举报管理等功能。
...
**UniFind 校园寻宝** 是一个完整的校园失物招领平台，旨在帮助师生快速发布和查找失物信息。系统支持用户注册登录、物品发布与管理、收藏与认领、物品评论、实时私信、举报处理、隐私设置及分级管理后台等完整功能。
...
#### 账号管理
- ✅ 学生/教师注册（教师注册后需管理员审核，审核通过后获得中级管理员权限）
- ✅ 登录/退出登录
- ✅ 忘记密码重置功能
